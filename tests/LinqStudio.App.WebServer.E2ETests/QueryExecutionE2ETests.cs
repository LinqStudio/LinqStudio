...
public class QueryExecutionE2ETests(AppServerFixture app, PlaywrightFixture pw)
{
	...
	public async Task Execute_ShowsResults_WhenQuerySucceeds()
	{
		...
		await E2ETestHelpers.ClearAndWriteQueryAsync(page, $"{E2ETestHelpers.SqliteContextParameterName}.People.Take(5)");
	...
	public async Task Execute_StopButton_CancelsExecution()
	{
		...
		await E2ETestHelpers.ClearAndWriteQueryAsync(page, $"{E2ETestHelpers.SqliteContextParameterName}.People.ToList()");
	...
	public async Task Execute_ShowsEmptyResultSet_WhenQueryReturnsNoRows()
	{
		...
		await E2ETestHelpers.ClearAndWriteQueryAsync(page, $"{E2ETestHelpers.SqliteContextParameterName}.People.Where(x => x.Id == -99999)");
