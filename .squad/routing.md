...
|-----------|----------|----------|
| Architecture, feature planning, ADRs | Samy | Designing new feature flows, cross-layer decisions, reviewing complex PRs |
| Blazor UI, MudBlazor, Monaco editor | EvilJosh | Razor components, theming, settings UI, editor behavior |
